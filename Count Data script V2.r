...
##### Volcano plots UNDER ALL PFAM CvsDr
library(ggplot2)
...
##### Volcano plots UNDER ALL PFAM CvsDxD
library(ggplot2)
...
##### Volcano plots INTER pathogenicity CvsDi
library(ggplot2)
tmp <- read.csv("DESeq2_inter_pathogenicity_CvsDi.csv")
...
jpeg("Inter_pathogenicity_CvsDi_TEST.jpeg",height=5,width=5,units = 'in', res = 600)#height in inches, resolution 600 dpi
plot(Inter_ALL_pfam_CvsDi)
dev.off()
...
##### Volcano plots INTER pathogenicity CvsDr
library(ggplot2)
tmp <- read.csv("DESeq2_inter_pathogenicity_CvsDr.csv")
...
jpeg("Inter_pathogenicity_CvsDr_TEST.jpeg",height=5,width=5,units = 'in', res = 600)#height in inches, resolution 600 dpi
plot(Inter_ALL_pfam_CvsDr)
dev.off()



##### Volcano plots INTER pathogenicity CvsDxD
library(ggplot2)
tmp <- read.csv("DESeq2_inter_pathogenicity_CvsDxD.csv")
...
jpeg("Inter_pathogenicity_CvsDxD_TEST.jpeg",height=5,width=5,units = 'in', res = 600)#height in inches, resolution 600 dpi
plot(Inter_ALL_pfam_CvsDxD)
dev.off()



##### Volcano plots UNDER pathogenicity CvsDi
library(ggplot2)
tmp <- read.csv("DESeq2_under_pathogenicity_CvsDi.csv")
...
jpeg("Under_pathogenicity_CvsDi_TEST.jpeg",height=5,width=5,units = 'in', res = 600)#height in inches, resolution 600 dpi
plot(Under_ALL_pfam_CvsDi)
dev.off()



##### Volcano plots UNDER pathogencity CvsDr
library(ggplot2)
tmp <- read.csv("DESeq2_under_pathogenicity_CvsDr.csv")
...
jpeg("Under_pathogenicity_CvsDr_TEST.jpeg",height=5,width=5,units = 'in', res = 600)#height in inches, resolution 600 dpi
plot(Under_ALL_pfam_CvsDr)
dev.off()



##### Volcano plots UNDER pathogenicity CvsDxD
library(ggplot2)
tmp <- read.csv("DESeq2_under_pathogenicity_CvsDxD.csv")
...
jpeg("Under_pathogenicity_CvsDxD_TEST.jpeg",height=5,width=5,units = 'in', res = 600)#height in inches, resolution 600 dpi
plot(Under_ALL_pfam_CvsDxD)
dev.off()



###control vs disturbance only INTER STRESS 

mycounts <- read.csv("countData_inter_CvsDi_STRESS.csv")
metadata <- read.csv("colData_inter_CvsDi.csv")
...
write.table(res_inter, file="DESeq2_inter_STRESS_CvsDi.csv", row.names=F, sep=",")


###control vs drought only INTER STRESS 

mycounts <- read.csv("countData_inter_CvsDr_STRESS.csv")
metadata <- read.csv("colData_inter_CvsDr.csv")
...
write.table(res_inter, file="DESeq2_inter_STRESS_CvsDr.csv", row.names=F, sep=",")


###control vs DxD only INTER STRESS 

mycounts <- read.csv("countData_inter_CvsDxD_STRESS.csv")
metadata <- read.csv("colData_inter_CvsDxD.csv")
...
write.table(res_inter, file="DESeq2_inter_STRESS_CvsDxD.csv", row.names=F, sep=",")



###control vs disturbance only UNDER STRESS 

mycounts <- read.csv("countData_under_CvsDi_STRESS.csv")
metadata <- read.csv("colData_under_CvsDi.csv")
...
write.table(res_under, file="DESeq2_under_STRESS_CvsDi.csv", row.names=F, sep=",")


###control vs drought only UNDER STRESS 

mycounts <- read.csv("countData_under_CvsDr_STRESS.csv")
metadata <- read.csv("colData_under_CvsDr.csv")
...
write.table(res_under, file="DESeq2_under_STRESS_CvsDr.csv", row.names=F, sep=",")


###control vs DxDx only UNDER STRESS 

mycounts <- read.csv("countData_under_CvsDxD_STRESS.csv")
metadata <- read.csv("colData_under_CvsDxD.csv")
...
write.table(res_under, file="DESeq2_under_STRESS_CvsDxD.csv", row.names=F, sep=",")



##### Volcano plots INTER STRESS CvsDi
library(ggplot2)
tmp <- read.csv("DESeq2_inter_STRESS_CvsDi.csv")
...
jpeg("Inter_STRESS_CvsDi_TEST.jpeg",height=5,width=5,units = 'in', res = 600)#height in inches, resolution 600 dpi
plot(Inter_ALL_pfam_CvsDi)
dev.off()
...
##### Volcano plots INTER STRESS CvsDr
library(ggplot2)
tmp <- read.csv("DESeq2_inter_STRESS_CvsDr.csv")
...
jpeg("Inter_STRESS_CvsDr_TEST.jpeg",height=5,width=5,units = 'in', res = 600)#height in inches, resolution 600 dpi
plot(Inter_ALL_pfam_CvsDr)
dev.off()
...
##### Volcano plots INTER pathogenicity CvsDxD
library(ggplot2)
tmp <- read.csv("DESeq2_inter_STRESS_CvsDxD.csv")
...
jpeg("Inter_STRESS_CvsDxD_TEST.jpeg",height=5,width=5,units = 'in', res = 600)#height in inches, resolution 600 dpi
plot(Inter_ALL_pfam_CvsDxD)
dev.off()



##### Volcano plots UNDER STRESS CvsDi
library(ggplot2)
tmp <- read.csv("DESeq2_under_STRESS_CvsDi.csv")
...
jpeg("Under_STRESS_CvsDi_TEST.jpeg",height=5,width=5,units = 'in', res = 600)#height in inches, resolution 600 dpi
plot(Under_ALL_pfam_CvsDi)
dev.off()
...
##### Volcano plots UNDER pathogencity CvsDr
library(ggplot2)
tmp <- read.csv("DESeq2_under_STRESS_CvsDr.csv")
...
jpeg("Under_STRESS_CvsDr_TEST.jpeg",height=5,width=5,units = 'in', res = 600)#height in inches, resolution 600 dpi
plot(Under_ALL_pfam_CvsDr)
dev.off()
...
##### Volcano plots UNDER pathogenicity CvsDxD
library(ggplot2)
tmp <- read.csv("DESeq2_under_STRESS_CvsDxD.csv")
...
jpeg("Under_STRESS_CvsDxD_TEST.jpeg",height=5,width=5,units = 'in', res = 600)#height in inches, resolution 600 dpi
plot(Under_ALL_pfam_CvsDxD)
dev.off()
